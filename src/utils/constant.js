...
export const GIF_SUCCESS = 'Gif successfully created';
...
export const RETRIEVED = 'Users fetched successfully';
...
export const EDIT_NOT_ALLOWED = 'You cannot edit another user article';
export const DELETE_NOT_ALLOWED = 'You cannot delete another user article';
export const ARTICLE_FLAGGED = 'This article has been flagged succesfuly';
export const DOES_NOT_EXIST = 'article does not exist';
export const FLAGGED_EXIST = 'article already flagged by you';
